...
şifresi_kırılmış_hali = harfler[harfler.index(kelime[0]) -1] + harfler[harfler.index(kelime[1])-1] + harfler[harfler.index(kelime[2]) - 1]

print(kelime[0] + "----------->" + harfler[harfler.index(kelime[0])-1])
print(kelime[1] + "----------->" + harfler[harfler.index(kelime[1])-1])
print(kelime[2] + "----------->" + harfler[harfler.index(kelime[2])-1])

print(şifreli_kelime,"Çözülmüş Hali:", şifresi_kırılmış_hali)

//// AYNI KODLAR OLMASINA RAĞMEN FARKLI SONUÇ???
